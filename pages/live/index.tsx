  ...
  return (
    <Layout title="라이브" hasTabBar>
      <div className="py-10 divide-y-2 space-y-4">
        ...
        <button className="fixed bottom-24 right-7 p-3 bg-orange-400 hover:bg-orange-500 transition-colors rounded-full text-white cursor-pointer border-transparent">
          <svg
